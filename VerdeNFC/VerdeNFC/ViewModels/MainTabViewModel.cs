...
//            OpenWebCommand = new Command(async () => await Browser.OpenAsync("https://xamarin.com"));
            ...
            // RoastProfiles.Add(new RoastProfile() { Id = 101, Name = "(RGB from NFC or File)", Data = "", isManualChoiceAllowed = false});
            // RoastProfiles.Add(new RoastProfile() { Id = 102, Name = "(Roast from NFC or File)", Data = "", isManualChoiceAllowed = false});
            ...
            RoastProfiles.Add(new RoastProfile() { Id = 5, Name = "80g Slow Roast RGB (10h)",      Data = "AAB84B4B00 AAB832465A  AAB64B5A00 AAB6324664 3C465A2D 32 01  2D  000501 CCFE 0258", isManualChoiceAllowed = true });

            RoastProfiles.Add(new RoastProfile() { Id = 6, Name = "universal dark roast ",         Data = "AA645A3205 AA9632327D  AAB4463C05 AAC0323C96 376E3C2D 23 02  0F  000601 8312 000A", isManualChoiceAllowed = true });
            ...
            RoastProfiles.Add(new RoastProfile() { Id = 91, Name = "(Air Filter Reset)",           Data = "AA96644B05 AA96413278  AAAC5F5005 AAB6414696 376E5A2D 23 0F  0F  000601 8D7C 0000", isManualChoiceAllowed = true });
